...
import sys
sys.path.insert(0 ,"~/Desktop/cmpt726/quad_stabilization/catkin_ws/devel/lib/python3/dist-packages")
print(sys.path)
import gym
...
if __name__ == "__main__":
   ...
   if args['algo'] == "ppo":
       ...
       env = gym.make(args['gym_env'], rew=args['rew_type'])
       LOAD_DIR = '~/Desktop/cmpt726/quad_stabilization' + '/runs_log_tests/14-Dec-2020_22-46-17QuadTakeOffHoverEnv-v0_ppo/model'
